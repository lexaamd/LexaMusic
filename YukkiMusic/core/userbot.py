...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("amandes_nih")
                await self.one.join_chat("amandes_suport")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("amandes_nih")
                await self.two.join_chat("amandes_suport")
            except:
                pass
            assistants.append(2)
            try:
